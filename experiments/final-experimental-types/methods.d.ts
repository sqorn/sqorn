import {
  A, S, U, D, I, V, M, H, X,
  Keys, RequiredKeys, Query, States, Except
} from "./queries";
...
export interface With<T extends Keys> {
   ...
   * TODO
   */
  with(strings: TemplateStringsArray, ...args: any[]): Next<T, WithD, WithA>;
}
...
export interface From<T extends Keys> {
   ...
   * // select * from book
   */
  from(strings: TemplateStringsArray, ...args: any[]): Next<T, FromD, FromA>;
   ...
   */
  from(builder: Expression): Next<T, FromD, FromA>;
   ...
   */
  from(...tables: string[]): Next<T, FromD, FromA>;
}

type ReturnD = S | U | D | I;
type ReturnA = X;
...
export interface Return<T extends Keys> {
   ...
   */
  return(strings: TemplateStringsArray, ...args: any[]): Next<T, ReturnD, ReturnA>;
...
export interface Where<T extends Keys> {
   ...
   * // select * from person where age < 18
   */
  where(strings: TemplateStringsArray, ...args: any[]): Next<T, WhereD, WhereA>;
   ...
   */
  where(...conditions: NEArray<Conditions>): Next<T, WhereD, WhereA>;
}
...
export interface Order<T extends Keys> {
   ...
   * TODO
   */
  order(strings: TemplateStringsArray, ...args: any[]): Next<T, OrderD, OrderA>;
}
...
export interface Limit<T extends Keys> {
   ...
   * TODO
   */
  limit(strings: TemplateStringsArray, ...args: any[]): Next<T, LimitD, LimitA>;
}
...
export interface Offset<T extends Keys> {
   ...
   * TODO
   */
  offset(strings: TemplateStringsArray, ...args: any[]): Next<T, OffsetD, OffsetA>;
}
...
export interface Group<T extends Keys> {
   ...
   * TODO
   */
  group(strings: TemplateStringsArray, ...args: any[]): Next<T, GroupD, GroupA>;
}
...
export interface Having<T extends Keys> {
   ...
   * TODO
   */
  having(strings: TemplateStringsArray, ...args: any[]): Next<T, HavingD, HavingA>;
}
...
export interface Insert<T extends Keys> {
   ...
   * // insert into person (age) values (23), (40) returning id
   */
  insert(strings: TemplateStringsArray, ...args: any[]): Next<T, InsertD, InsertA>;
   ...
   * // insert into person (age) values (23), (40) returning id
   */
  insert(...columns: string[]): Next<T, InsertD, InsertA>;
   ...
   */
  insert(...values: { [column: string]: any }[]): Next<T, InsertD, InsertA>;
}
...
export interface Set<T extends Keys> {
   ...
   * TODO
   */
  set(strings: TemplateStringsArray, ...args: any[]): Next<T, SetD, SetA>;
   ...
   * TODO
   */
  set(value: { [column: string]: any }): Next<T, SetD, SetA>;
}
...
export interface Delete<T extends Keys> {
   ...
   * // delete from person where age < 7 returning id
   */
  readonly delete: Next<T, DeleteD, DeleteA>;
}
...
export interface SQL<T extends Keys> {
   ...
   *
   */
  l(strings: TemplateStringsArray, ...args: any[]): Next<T, SQLD, SQLA>;
...
interface Execute<T extends Keys> extends Promise<Row[]> {
  /**
